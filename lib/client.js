	...
	factory: (require) => {
		...
		function DevEnvView(props) {
		  ...
		  function load(force) {
		    setLoading(true);
		    setError(null);
		    rpcCall(connection, "dev-env/scan", { force: force === true }).then(function(value) {
		      setScan(value);
		    }).catch(function(err) {
		      setError(err.message ?? String(err));
		    }).finally(function() {
		  ...
		  useEffect12(function() {
		    ...
		    setLoading(true);
		    setError(null);
		    rpcCall(connection, "dev-env/scan", { force: false }).then(function(value) {
		  ...
		  children.push(createElement14("button", {
		    key: "scan",
		    className: "pcc-btn pcc-btn-primary",
		    style: { width: "100%", padding: "10px 0" },
		    disabled: loading,
		  ...
		  if (scan) {
		    children.push(createElement14(
		      ...
		      createElement14(
		        "div",
		        { className: "pcc-stat" },
		        createElement14("div", { className: "pcc-stat-value" }, envVars.length),
		        createElement14("div", { className: "pcc-stat-label" }, "\u5DF2\u914D\u7F6E\u73AF\u5883\u53D8\u91CF")
		      ),
		      createElement14(
		        "div",
		        { className: "pcc-stat" },
		      ...
		      createElement14(
		        "div",
		        { className: "pcc-stat" },
		        createElement14("div", { className: "pcc-stat-value" }, cDirs.length),
		        createElement14("div", { className: "pcc-stat-label" }, "\u4F4D\u4E8E C \u76D8\u7684\u76EE\u5F55")
		      )
		    ));
		    ...
		    children.push(createElement14(
		      "p",
		      { key: "env-title", className: "pcc-section-title", style: { marginTop: "10px" } },
		      "\u73AF\u5883\u53D8\u91CF"
		    ));
		    if (envVars.length === 0) {
		      children.push(createElement14(
		      ...
		      envVars.forEach(function(e) {
		        var meta = e.exists ? e.isDirectory ? "\u76EE\u5F55\u5B58\u5728" : e.isFile ? "\u6587\u4EF6\u5B58\u5728" : "\u8DEF\u5F84\u5B58\u5728" : "\u8DEF\u5F84\u672A\u627E\u5230";
		        children.push(createElement14(
		          "div",
		          { key: "env-" + e.key, className: "pcc-env-item" },
		          createElement14(
		            "div",
		            { className: "pcc-env-main" },
		            createElement14("span", { className: "pcc-env-name" }, e.key),
		            createElement14("span", { className: "pcc-env-label" }, e.label)
		          ),
		          createElement14("div", { className: "pcc-env-path", title: e.value }, e.value || "-"),
		          createElement14("span", {
		            className: "pcc-badge",
		            "data-warn": !e.exists || void 0
		          }, meta)
		        ));
		      });
		    }
		    children.push(createElement14(
		      "p",
		      { key: "dirs-title", className: "pcc-section-title", style: { marginTop: "14px" } },
		      "\u7528\u6237\u76EE\u5F55 / AppData \u5F00\u53D1\u7F13\u5B58"
		    ));
		    if (knownDirs.length === 0) {
		      ...
		      knownDirs.forEach(function(d) {
		        ...
		        var meta = d.exists ? d.tool + " \xB7 " + (d.fileCount ?? 0).toLocaleString() + " \u6587\u4EF6 \xB7 " + (d.dirCount ?? 0).toLocaleString() + " \u76EE\u5F55" : d.tool + " \xB7 \u672A\u53D1\u73B0";
		        children.push(createElement14(
		          "div",
		          {
		            key: "dir-" + d.id,
		          ...
		          createElement14("div", { className: "pcc-devdir-path", title: d.path }, d.path),
		          createElement14(
		            "div",
		            { className: "pcc-devdir-foot" },
		            createElement14("span", null, meta),
		            cDrive && d.exists ? createElement14("span", { className: "pcc-badge" }, "C \u76D8") : null
		          )
		        ));
		      });
		    }
		...
		// src/client/panel.js
		var useState14 = React9.useState;
		...
		// src/client/index.js
		var createElement18 = React10.createElement;
