...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var createElement4 = React3.createElement;
		function useAnimatedNumber(target) {
		  var valueState = useState4(target);
		...
		var createElement6 = React4.createElement;
		...
		var useEffect6 = React5.useEffect;
		var createElement8 = React5.createElement;
		...
		var useState8 = React6.useState;
		var useEffect8 = React6.useEffect;
		var createElement10 = React6.createElement;
		...
		var useState10 = React7.useState;
		var useEffect10 = React7.useEffect;
		var createElement12 = React7.createElement;
		...
		// src/client/panel.js
		var useState12 = React8.useState;
		var useEffect12 = React8.useEffect;
		var useLayoutEffect2 = React8.useLayoutEffect;
		var useRef4 = React8.useRef;
		var createElement14 = React8.createElement;
		var Fragment2 = React8.Fragment;
		...
		function CleanerPanelBody(props) {
		  ...
		  var body;
		  if (view === "scanning") {
		    body = createElement14(ScanningView, {
		      connection,
		      status,
		    ...
		    body = createElement14(ResultView, {
		      ctx,
		      connection,
		    ...
		    body = createElement14(SelectView, {
		      connection,
		      onStart: handleStart,
		  ...
		  var title = "\u{1F9F9} \u78C1\u76D8\u54E8\u5175" + (pageNames[view] ? " \xB7 " + pageNames[view] : "");
		  return createElement14(
		    ...
		    createElement14(
		      ...
		      canBack ? createElement14("button", {
		      ...
		      createElement14("h3", { className: "pcc-panel-title" }, title),
		...
		function PCCleanerPanel(props) {
		  ...
		  return createElement14(
		    "div",
		    { className: "pcc-panel" },
		    createElement14(CleanerPanelBody, { ctx })
		  );
		}
		...
		function PCCleanerSidebarAction(props) {
		  ...
		  var ctx = props.ctx;
		  var open = usePanelOpen();
		  var btnRef = useRef4(null);
		  var anchorRef = useRef4(null);
		  var mountState = useState12(null);
		  ...
		  return createElement14(
		    Fragment2,
		    null,
		    createElement14("span", { ref: anchorRef, className: "pcc-sidebar-anchor", "aria-hidden": true }),
		    createElement14(
		      "button",
		      {
		        ref: btnRef,
		      ...
		      createElement14("span", {
		        className: "pcc-sidebar-icon",
		        "aria-hidden": true,
		        dangerouslySetInnerHTML: { __html: disk_sentinel_default }
		      }),
		      iconOnly ? null : createElement14("span", { className: "pcc-sidebar-label" }, "\u78C1\u76D8\u54E8\u5175"),
		      open && !iconOnly ? createElement14("span", { className: "pcc-sidebar-caret", "aria-hidden": true }, "\u25C2") : null
		    )
		  );
		}
		
		// src/client/index.js
		var createElement16 = React9.createElement;
		      ...
		      return ctx.slots.inject(
		        ...
		        function() {
		          return ctx.slots.register(
		            ...
		            function(props) {
		              return createElement16(PCCleanerSidebarAction, {
		                ctx,
		                wide: (props ?? {}).wide
		              });
		            }
		      ...
		      return ctx.slots.inject(
		        ...
		        function() {
		          return ctx.slots.register(
		            ...
		            function(props) {
		              return createElement16(PCCleanerPanel, { ctx });
		            }
		          );
		        }
		      );
