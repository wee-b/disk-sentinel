		  ...
		  if (scan) {
		    ...
		    if (knownDirs.length === 0) {
		      ...
		      knownDirs.forEach(function(d) {
		        ...
		        var meta = d.isLink && d.linkTarget ? d.tool + " \xB7 \u5DF2\u8FC1\u79FB\u5230 " + d.linkTarget : d.exists ? d.tool + " \xB7 " + (d.fileCount ?? 0).toLocaleString() + " \u6587\u4EF6 \xB7 " + (d.dirCount ?? 0).toLocaleString() + " \u76EE\u5F55" : d.tool + " \xB7 \u672A\u53D1\u73B0";
		        children.push(createElement14(
		          "div",
		          {
		            key: "dir-" + d.id,
		          ...
		          createElement14(
		            ...
		            createElement14(
		              ...
		              d.isLink ? createElement14("span", { className: "pcc-badge" }, "\u5DF2\u8FC1\u79FB") : null,
		              !d.isLink && cDrive && d.exists ? createElement14("span", { className: "pcc-badge" }, "C \u76D8") : null,
		              d.exists && d.manualMigration ? createElement14("button", {
